...
def calculate_interpolation(AGB_masses, AGB_metallicities, splines, mapto, AGB_divisor, mu_specie):
	mass_created = np.array([mu_specie] * len(AGB_masses)) * 0.
	...
	mass_created /= AGB_divisor
	mass_created[mass_created < 0.] = 0.
